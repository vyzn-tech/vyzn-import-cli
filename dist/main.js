...
async function importCatalogComponents(input, url, auth, category, verbose, diff) {
    const lcaAttributeGroup = 'Ökobilanz';
    await assertFile(input);
    await assertUrl(url);
    await assertFile(auth);
...
async function importProductsOfType(products, type, selectedCatalogueId, selectedRoot, hierarchy, productTypeNameToCategoryTypeIdMap, lcaAttributeGroupId, url, auth, verbose, diff) {
...
async function importSingleProduct(prodKey, prod, selectedCatalogueId, selectedRoot, hierarchy, productTypeNameToCategoryTypeIdMap, lcaAttributeGroupId, url, authToken, verbose, diff) {
